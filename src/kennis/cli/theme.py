...
*is*. It names no library. `rich_theme` below turns the table into a
...
The restriction is the reason `rich_theme` restates rich's own progress
...
ROLES: Final[dict[str, Role]] = {
    ...
    # onto rich's own style names by `_RICH_PROGRESS_STYLES` below.
